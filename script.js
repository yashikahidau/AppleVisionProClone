...
tl5.to("#page5-top>img", {
  bottom: `40%`,
  opacity:1
})
tl5.to("#page5-top>span", {
  bottom: `20%`,
  opacity:1
})
...
// videos width change page 6
var video6 = gsap.timeline({
  scrollTrigger:
  {trigger:`#page6`,
  scroller:`#main`,
  start:`0.1% top`,
...
// videos width change page 7
var video7 = gsap.timeline({
  scrollTrigger:
  {trigger:`#page7`,
  scroller:`#main`,
  start:`0.1% top`,
...
// videos width change page 8
var video8 = gsap.timeline({
  scrollTrigger:
  {trigger:`#page8`,
  scroller:`#main`,
  start:`0.1% top`,
...
// videos width change page 9
var video9 = gsap.timeline({
  scrollTrigger:
  {trigger:`#page9`,
  scroller:`#main`,
  start:`0.1% top`,
...
// videos width change page 21
var video21 = gsap.timeline({
  scrollTrigger:
  {trigger:`#page21`,
  scroller:`#main`,
  start:`0.1% top`,
